...
description: 'To help with prompts that exceed the maximum context size of a model, OpenRouter supports a custom parameter called `transforms`'
---
...
<Tip>All OpenRouter models default to using middle-out. To exclude this transform, set transforms: [] in the request body.</Tip>