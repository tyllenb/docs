...
description: Integrate OAuth into your application and give developers tons of models to provide to their users.
---
<iframe
  width="730"
  height="420"
...
>
    Click here to view the Github this guide is based on.
</Card>
